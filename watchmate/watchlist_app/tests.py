...
class StreamPlatformTestCase(APITestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(username="example", password="Password@124")
...
class WatchListTestCase(APITestCase):
    ...
    def test_watchlist_ind(self):
        ...
        self.assertCountEqual(models.WatchList.objects.get().title, 'Example Movie')
...
class ReviewTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.watchlist2 = models.WatchList.objects.create(platform=self.stream, title="Example Movie",
                                                         storyline="Example Movie", active=True)
        self.review = models.Review.objects.create(review_user=self.user, rating=5, description="Greta Movie!",
